...
namespace SHS_Performans
{
    public partial class f_tyt_fenbil10 : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytFenBilSorulari10.xml");
        ...
        private void f_tyt_fenbil10_Load(object sender, EventArgs e)
        {
            CenterToScreen();
