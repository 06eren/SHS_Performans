...
namespace SHS_Performans
{
    public partial class f_ayt_sosyalbil : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("aytSosyalBilSorulari.xml");
        ...
        private void f_ayt_sosyalbil_Load(object sender, EventArgs e)
        {
            CenterToScreen();
