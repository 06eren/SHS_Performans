...
namespace SHS_Performans
{
    public partial class f_tyt_sosyalbil5 : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytSosyalBilSorulari5.xml");
        ...
        private void f_tyt_sosyalbil5_Load(object sender, EventArgs e)
        {
            CenterToScreen();
