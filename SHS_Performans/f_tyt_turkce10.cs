...
namespace SHS_Performans
{
    public partial class f_tyt_turkce10 : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytTurkceSorulari10.xml");
        ...
        private void f_tyt_turkce10_Load(object sender, EventArgs e)
        {
            CenterToScreen();
