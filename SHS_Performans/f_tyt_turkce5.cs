...
namespace SHS_Performans
{
    public partial class f_tyt_turkce5 : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytTurkceSorulari5.xml");
        ...
        private void f_tyt_turkce5_Load(object sender, EventArgs e)
        {
            CenterToScreen();
