...
namespace SHS_Performans
{
    public partial class f_ayt_matematik : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("aytMatematikSorulari.xml");
        ...
        private void f_ayt_matematik_Load(object sender, EventArgs e)
        {
            CenterToScreen();
