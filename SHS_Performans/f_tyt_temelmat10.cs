...
namespace SHS_Performans
{
    public partial class f_tyt_temelmat10 : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytTemelMatSorulari10.xml");
        ...
        private void f_tyt_temelmat10_Load(object sender, EventArgs e)
        {
            CenterToScreen();
