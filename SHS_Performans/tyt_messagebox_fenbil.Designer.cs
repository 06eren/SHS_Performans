...
{
    partial class tyt_messagebox_fenbil
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(tyt_messagebox_fenbil));
            button3 = new Button();
            button2 = new Button();
            button1 = new Button();
            label1 = new Label();
            ...
            Controls.Add(label1);
            Name = "tyt_messagebox_fenbil";
            Text = "Soru Seçiniz";
            Load += tyt_messagebox_fenbil_Load;
            ResumeLayout(false);
            PerformLayout();
        }
