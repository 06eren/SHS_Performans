...
namespace SHS_Performans
{
    public partial class f_ayt_edebiyat : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("aytEdebiyatSorulari.xml");
        ...
        private void f_ayt_edebiyat_Load(object sender, EventArgs e)
        {
            CenterToScreen();
