...
{
    partial class tyt_messagebox_temelmat
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(tyt_messagebox_temelmat));
            button3 = new Button();
            button2 = new Button();
            button1 = new Button();
            label1 = new Label();
            ...
            Controls.Add(label1);
            Name = "tyt_messagebox_temelmat";
            Text = "Soru Sayısını Seçiniz";
            Load += tyt_messagebox_temelmat_Load;
            ResumeLayout(false);
            PerformLayout();
        }
