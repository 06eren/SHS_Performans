...
namespace SHS_Performans
{
    public partial class f_tyt_temelmat : Form
    {
        ...
        private void SorulariBaslat()
        {
            ...
            doc.Load("tytTemelMatSorulari.xml");
        ...
        private void f_tyt_temelmat_Load(object sender, EventArgs e)
        {
            CenterToScreen();
